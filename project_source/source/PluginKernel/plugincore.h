...
public:
	...
	std::pair<double, double> x_1 = std::make_pair(0.0, 0.0);
	std::pair<double, double> x_2 = std::make_pair(0.0, 0.0);
	std::pair<double, double> y_1 = std::make_pair(0.0, 0.0);
	std::pair<double, double> y_2 = std::make_pair(0.0, 0.0);
	double a_0 = 0.0;
	double a_1 = 0.0;
	double a_2 = 0.0;
	double b_1 = 0.0;
	...
	std::unique_ptr<double[]> buffer_L = nullptr;
	std::unique_ptr<double[]> buffer_R = nullptr;
	unsigned int writeIndex = 0;
	unsigned int bufferLength = 1024;
	unsigned int wrapMask = 1023;

	void writeBuffer(double input, std::unique_ptr<double[]>& buffer);
	double readBuffer(int delay, std::unique_ptr<double[]>& buffer);
...
private:
	//  **--0x07FD--**
	int modType = 0;
	enum class modTypeEnum { XOR, AND, OR };
	double modLevel = 0.00000000;
	double mix = 0.50000000;
	int phaseFlip = 0;
	enum class phaseFlipEnum { NONE, PRE, POST, BOTH };
	int lagSamples = 0;
	int multiFilterPosition = 0;
	enum class multiFilterPositionEnum { OFF, PRE, POST };
	double lpfCutoff = 1000.0;
	double lpfQ = 0.707;
	double lpfMix = 0.0;
	double hpfMix = 0.0;
	double apfMix = 0.0;
